...
PRESETS: dict[str, Preset] = {
    "portrait": Preset(
        ...
        description="CodeFormer (0.80) + Denoise 0% + Grain 2% + Real Smile (Natural skin & real teeth)",
        model="x4plus",
        scale=4,
        denoise_strength=0,
        grain_strength=2,
    ...
    "vintage_film": Preset(
        ...
        description="CodeFormer (0.75) + Denoise 20% + Grain 5% (Authentic 35mm grain)",
        model="x4plus",
        scale=4,
        denoise_strength=20,
        grain_strength=5,
    ...
    "low_light": Preset(
        ...
        description="CodeFormer (0.70) + Denoise 30% + Grain 2% (Removes chroma noise)",
        model="x4plus",
        scale=4,
        denoise_strength=30,
        grain_strength=2,
